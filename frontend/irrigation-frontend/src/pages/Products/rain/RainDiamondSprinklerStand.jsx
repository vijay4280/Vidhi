...
const RainDiamondSprinklerStand = () => {
  return (
    <>
      {/* PAGE HEADER */}
      <ProductHeader
        title='1-1/2" Rain Diamond Sprinkler Stand'
        bgImage="/img/Rain-head-4.png"
        titleClass="text-success"
        breadcrumbs={[
          { label: "Home", link: "/" },
          { label: "Rain Sprinkler", link: "/products/rain" },
          { label: '1-1/2" Rain Diamond Sprinkler Stand' },
        ]}
      />
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 mt-5">
              <h2 className="text-success">
                1-1/2&quot; RAIN DIAMOND SPRINKLER STAND
              </h2>
              <hr className="border-success" />
...
export default RainDiamondSprinklerStand;
